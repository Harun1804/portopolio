                    ...
                    <ul class="about-info mt-4 px-md-0 px-2">
                        @if ($editMode)
                            <form wire:submit.prevent="update" method="POST" enctype="multipart/form-data">
                                ...
                                <li class="d-flex"><span>Thumbnail</span> <span><input type="file" placeholder="newImage" class="form-control" wire:model="newImage" wire:ignore.self></span></li>
                ...
                <tbody>
                    @forelse ($projects as $project)
                        <tr>
                            ...
                            <td>{{ $project->desc }}</td>
                            <td>
                                <img src="{{ $project->thumbnail }}" width="50px" alt="img" class="img img-fluid">
                            </td>
                        </tr>
                    @empty
                        <tr>
